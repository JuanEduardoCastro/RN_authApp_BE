...
const createSESGoodbyeEmail = (to: string, name: string) => {
  return {
    to,
    subject: "Your Auth.Jc account has been deleted",
    text: `Hi ${name},\n\nYour Auth.Jc account has been permanently deleted. We
    ...
    html: `
        ...
        <body style="margin: 0; padding: 0; background-color: #f1f5f9;">
          <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
            <tr>
              <td align="center" style="padding: 20px 0 30px 0;">
                <table border="0" cellpadding="0" cellspacing="0" width="600" class="container" style="border-collapse: collapse; background-color: #f1f5f9;">
                  <tr>
                    <td align="center" style="padding: 40px 0 20px 0; background-color: #7646c9;">
                      <h1 style="color: #f1f5f9; margin: 0; font-size: 24px;">Auth.Jc</h1>
                    </td>
                  ...
                  <tr>
                    <td style="padding: 40px; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; color: #333333;" class="content">
                      ...
                      <p style="margin: 0 0 15px 0;">Your <strong>Auth.Jc</strong> account has been permanently deleted. All your data has been erased from our servers.</p>
                      <p style="margin: 0 0 15px 0;">We're sorry to see you go. If this was a mistake or you have any questions, please reach out to us.</p>
                      <p style="margin: 0;">We hope to see you again someday.</p>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" style="padding: 30px; background-color: #eeeeee; font-family: Arial, sans-serif; font-size: 12px; line-height: 18px; color: #777777;">
                      <p style="margin: 0;">&copy; 2026 - Auth.Jc. All rights reserved.</p>
                      <p style="margin: 10px 0 0 0;">
                        <a href="mailto:${process.env.SES_FROM_EMAIL}" style="color: #777777; text-decoration: underline;">${process.env.SES_FROM_EMAIL}</a>
                      </p>
                    </td>
                  </tr>
                </table>
...
export const sendSESGoodbyeEmail = async (email: string, firstName: string) => {
  const name = firstName || "there";
  const payload = createSESGoodbyeEmail(email, name);
  await sendSESEmail(payload);
};
