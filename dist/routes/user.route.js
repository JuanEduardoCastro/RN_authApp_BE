...
/* --- FCM tokens Routes --- */
userRoutes.post("/device-token", limiters_1.deviceTokenLimiter, middleware_1.validateAccessTokenMiddleware, (0, express_validator_1.body)("fcmToken").isString().trim().isLength({ min: 10, max: 500 }), (0, express_validator_1.body)("deviceId").isString().trim().isLength({ min: 1, max: 200 }), (0, express_validator_1.body)("deviceName").optional().trim().isLength({ max: 100 }), (0, express_validator_1.body)("osVersion").optional().trim().isLength({ max: 50 }), (0, express_validator_1.body)("appVersion").optional().trim().isLength({ max: 50 }), deviceToken_controller_1.setDevicetoken);
