...
userRoutes.post("/login", (0, express_validator_1.body)("email").isEmail(), user_controller_1.loginUser);
...
userRoutes.post("/create", middleware_1.validateEmailTokenMiddleware, (0, express_validator_1.body)("email").isEmail(), (0, express_validator_1.body)("password").isLength({ min: 6 }), user_controller_1.createUser);
