...
const appleLogin_controller_1 = require("../controllers/appleLogin.controller");
const userRoutes = (0, express_1.Router)();
/* --- Authentication Routes --- */
userRoutes.post("/login", limiters_1.loginLimiter, (0, express_validator_1.body)("email").isEmail().normalizeEmail({ gmail_remove_dots: false }), user_controller_1.loginUser);
...
userRoutes.post("/create", limiters_1.createUserLimiter, middleware_1.validateEmailTokenMiddleware, middleware_1.validatePasswordMiddleWare, (0, express_validator_1.body)("email").isEmail().normalizeEmail({ gmail_remove_dots: false }), (0, express_validator_1.body)("password").isLength({ min: 8, max: 60 }), user_controller_1.createUser);
...
userRoutes.post("/check-email", limiters_1.checkEmailLimiter, (0, express_validator_1.body)("email").isEmail().normalizeEmail({ gmail_remove_dots: false }), user_controller_1.checkEmail);
userRoutes.post("/reset-password", limiters_1.resetPasswordLimiter, (0, express_validator_1.body)("email").isEmail().normalizeEmail({ gmail_remove_dots: false }), user_controller_1.resetPassword);
...
userRoutes.post("/apple-login", limiters_1.appleLoginLimiter, middleware_1.validateAppleMiddleware, appleLogin_controller_1.appleLogin);
